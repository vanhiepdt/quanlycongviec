...
const optional = {
  ...
  // Ngưỡng «gần đến hạn mà tiến độ chưa xong» (người dùng chốt 3 ngày, 2026-09-12). Nằm ở env cùng
  // lý do với CHAT_KEEP_DAYS: đổi ngưỡng thì không phải sửa mã và build lại image.
  DUE_SOON_DAYS: intIn(1, 60).default('3'),
