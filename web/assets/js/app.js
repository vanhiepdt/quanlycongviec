...
function linkifyText(text) {
  ...
  return text.replace(urlRegex, "<a href=\"$1\" target=\"_blank\" class=\"text-blue-600 hover:underline break-all\">$1</a>");
}
...
function setupOverviewProjectFilter() {
  ...
  function populateProjectDatalist() {
    overviewProjectListEl.innerHTML = allProjects.map(project => "<option value=\"" + project[COL.P_NAME] + " (" + project[COL.P_ID] + ")\" data-id=\"" + project[COL.P_ID] + "\"></option>").join("");
  }
...
function updateOverviewProjectDatalist() {
  ...
  overviewProjectListEl && allProjects.length > 0 && (overviewProjectListEl.innerHTML = allProjects.map(project => "<option value=\"" + project[COL.P_NAME] + " (" + project[COL.P_ID] + ")\" data-id=\"" + project[COL.P_ID] + "\"></option>").join(""));
}
...
function createTaskListItem(task, isCompact = false) {
  ...
  if (isCompact) return "\n            <div class=\"glass-card p-2 md:p-3 hover:shadow-md transition-shadow " + (isTaskOverdue2 ? "border-l-4 border-red-500" : "") + " task-clickable cursor-pointer draggable-item flex flex-col justify-between h-full bg-white border border-gray-100 rounded-xl\" \n                  data-id=\"" + taskId + "\" \n                  data-project-id=\"" + taskPid + "\"\n                  draggable=\"true\">\n                \n                <div class=\"flex justify-between items-start mb-1.5 md:mb-2 gap-2\">\n                    <h5 class=\"font-semibold text-gray-800 text-xs md:text-sm line-clamp-2 leading-snug flex-1\" title=\"" + taskName + "\">\n                        " + (isArray ? "<i class=\"fas fa-bell text-amber-500 mr-1 text-[10px] md:text-xs\"></i>" : "") + taskName + "\n                    </h5>\n                    " + (isTaskOverdue2 ? "<i class=\"fas fa-exclamation-circle text-red-500 text-[10px] md:text-xs shrink-0\" title=\"Quá hạn\"></i>" : "") + "\n                </div>\n\n                <div class=\"space-y-1.5 md:space-y-2 mt-auto\">\n                    <!-- Date & User -->\n                    <div class=\"flex items-center justify-between text-[10px] md:text-xs text-gray-500\">\n                        <div class=\"flex items-center gap-1.5 md:gap-2\">\n                             <span class=\"bg-gray-100 px-1.5 py-0.5 rounded text-[9px] md:text-[10px] font-mono\">" + taskId + "</span>\n                        </div>\n                        <span class=\"" + (isTaskOverdue2 ? "text-red-500 font-medium" : "") + "\">" + dueDateText + "</span>\n                    </div>\n\n                    <!-- Status & Priority -->\n                    <div class=\"flex items-center gap-1 md:gap-1.5 flex-wrap\">\n                        <span class=\"status-badge " + statusClass + " text-[9px] md:text-[10px] px-1 md:px-1.5 py-0.5\">" + taskStatus + "</span>\n                        <span class=\"status-badge " + priorityClass + " text-[9px] md:text-[10px] px-1 md:px-1.5 py-0.5\">" + taskPriority + "</span>\n                    </div>\n\n                    <!-- Actions & Progress -->\n                    <div class=\"flex items-center justify-between pt-1.5 md:pt-2 border-t border-gray-50 mt-0.5 md:mt-1\">\n                        <div class=\"flex items-center gap-1 text-[10px] md:text-xs text-gray-500 truncate max-w-[50%]\">\n                             <i class=\"fas fa-user-circle text-gray-400\"></i> " + taskAssignee + "\n                        </div>\n                        \n                         <div class=\"flex items-center gap-1\">\n                                " + (() => {
    ...
    return "\n                                    <button class=\"w-5 h-5 md:w-6 md:h-6 rounded hover:bg-gray-100 text-gray-400 hover:text-blue-600 action-btn-edit edit-btn flex items-center justify-center p-0\" data-type=\"task\" data-id=\"" + taskId + "\"><i class=\"fas fa-edit text-[10px] md:text-xs\"></i></button>\n                                    " + (isAdmin2 ? "<button class=\"w-5 h-5 md:w-6 md:h-6 rounded hover:bg-gray-100 text-gray-400 hover:text-red-600 action-btn-delete delete-btn flex items-center justify-center p-0\" data-type=\"task\" data-id=\"" + taskId + "\" data-name=\"" + taskName + "\"><i class=\"fas fa-trash text-[10px] md:text-xs\"></i></button>" : "") + "\n                                    ";
  })() + "\n                         </div>\n                    </div>\n                    \n                    <!-- Tiny Progress Bar -->\n                     <div class=\"w-full bg-gray-100 h-0.5 md:h-1 rounded-full overflow-hidden\">\n                        <div class=\"h-full " + (num === 100 ? "bg-green-500" : "bg-blue-500") + "\" style=\"width: " + num + "%\"></div>\n                     </div>\n                </div>\n            </div>\n            ";
  return "\n    <div class=\"glass-card p-4 hover:shadow-md transition-shadow " + (isTaskOverdue2 ? "border-l-4 border-red-500" : "") + " task-clickable cursor-pointer draggable-item\" \n          data-id=\"" + taskId + "\" \n          data-project-id=\"" + taskPid + "\"\n          draggable=\"true\">\n        <div class=\"flex items-center justify-between\">\n            <div class=\"flex-1\">\n                <h5 class=\"font-medium text-gray-900\">" + (isArray ? "<i class=\"fas fa-bell text-amber-500 mr-1\" title=\"Có nhắc việc\"></i>" : "") + taskName + " <span class=\"text-gray-500 text-xs\">(" + taskId + ")</span></h5>\n                \n                <div class=\"flex flex-wrap items-center gap-2 mt-2\">\n                    <span class=\"status-badge " + statusClass + "\">" + taskStatus + "</span>\n                    <span class=\"status-badge " + priorityClass + "\">" + taskPriority + "</span>\n                    " + (isTaskOverdue2 ? "<span class=\"status-badge status-overdue\">Quá hạn</span>" : "") + "\n                </div>\n            </div>\n            \n            <div class=\"ml-4 flex flex-col items-end\">\n                <div class=\"flex items-center space-x-1 mb-2\">\n                    " + (() => {
    const project = allProjects.find(project3 => project3[COL.P_ID] === task[COL.T_PID]),
      project2 = project && project[COL.P_MANAGER] === currentUser.name,
      isAdmin2 = isAdmin() || project2;
    return "\n                        " + (isAdmin2 ? "<button class=\"action-btn action-btn-copy copy-btn\" data-type=\"task\" data-id=\"" + taskId + "\" data-name=\"" + taskName + "\" title=\"Tạo bản sao\"><i class=\"fas fa-copy\"></i></button>" : "") + "\n                        <button class=\"action-btn action-btn-edit edit-btn\" data-type=\"task\" data-id=\"" + taskId + "\" title=\"Chỉnh sửa\"><i class=\"fas fa-edit\"></i></button>\n                        " + (isAdmin2 ? "<button class=\"action-btn action-btn-delete delete-btn\" data-type=\"task\" data-id=\"" + taskId + "\" data-name=\"" + taskName + "\" title=\"Xóa\"><i class=\"fas fa-trash\"></i></button>" : "") + "\n                      ";
  })() + "\n                </div>\n                <div class=\"flex items-center text-sm text-gray-600 mb-1\">\n                    <i class=\"fas fa-user mr-1\"></i>\n                    <span>" + taskAssignee + "</span>\n                </div>\n                <div class=\"flex items-center text-sm text-gray-600\">\n                    <i class=\"fas fa-calendar-alt mr-1\"></i>\n                    <span>" + dueDateText + "</span>\n                </div>\n            </div>\n        </div>\n        \n        <div class=\"mt-3\">\n            <div class=\"flex items-center justify-between text-xs text-gray-600 mb-1\">\n                <span>Tiến độ</span>\n                <span>" + num + "%</span>\n            </div>\n            <div class=\"h-1.5 bg-gray-200 rounded-full\">\n                <div class=\"h-full " + (taskStatus.toLowerCase().includes("hoàn thành") ? "bg-green-500" : "bg-blue-500") + " rounded-full\" style=\"width: " + num + "%\"></div>\n            </div>\n        </div>\n    </div>\n";
}
...
function createStaffTableRow(staff, staffType) {
  ...
  const deptCell = staffDept ? staffDept + (staffDeptRole && staffDeptRole !== "Nhân viên" ? " <span class=\"text-xs px-2 py-0.5 rounded-full bg-amber-100 text-amber-700\">" + staffDeptRole + "</span>" : "") : "<span class=\"text-gray-400\">—</span>";
  const text2 = "<span class=\"text-xs px-2 py-1 rounded-full " + text + "\">" + staffRole + "</span>";
  return "\n        <tr class=\"hover:bg-gray-50 transition-colors\">\n            <td class=\"px-3 py-2 font-medium text-gray-900\">" + staffName + "</td>\n            <td class=\"px-3 py-2 text-gray-600\">" + staffPos + "</td>\n            <td class=\"px-3 py-2 text-gray-600\">" + deptCell + "</td>\n            <td class=\"px-3 py-2\">" + text2 + "</td>\n            <td class=\"px-3 py-2 text-center\">\n                <div class=\"flex justify-center gap-1\">\n                    <button class=\"action-btn action-btn-edit edit-btn\" data-type=\"staff\" data-id=\"" + staffId + "\" title=\"Chỉnh sửa\">\n                        <i class=\"fas fa-edit text-xs\"></i>\n                    </button>\n                    <button class=\"action-btn action-btn-delete delete-btn\" data-type=\"staff\" data-id=\"" + staffId + "\" data-name=\"" + staffName + "\" title=\"Xóa\">\n                        <i class=\"fas fa-trash text-xs\"></i>\n                    </button>\n                </div>\n            </td>\n        </tr>";
}
...
function renderActivity(activities) {
  ...
  recentActivityEl.innerHTML = slice.map(slice2 => "\n    <div class=\"activity-item\">\n        <div class=\"flex items-start space-x-3\">\n            <div class=\"w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0\">\n                <i class=\"fas fa-history text-blue-600 text-xs\"></i>\n            </div>\n            <div class=\"flex-1 min-w-0\">\n                <p class=\"text-sm font-medium text-gray-900\">" + (slice2[COL.A_ACTION] || "Hành động") + "</p>\n                <p class=\"text-xs text-gray-600 mt-1\">" + (slice2[COL.A_DETAILS] || "") + "</p>\n                <p class=\"text-xs text-gray-500 mt-1\">\n                    " + (slice2[COL.A_USER] || "Ai đó") + " • " + formatDateForDisplay(slice2[COL.A_TIME], true) + "\n                </p>\n            </div>\n        </div>\n    </div>\n").join("");
}
...
function createProjectModal(isEdit, project) {
  ...
  }, 100), "\n  <div id=\"project-modal\" class=\"modal\">\n      <div class=\"modal-content\">\n          <div class=\"flex items-center justify-between mb-6\">\n              <h3 class=\"text-xl font-bold text-gray-900\">" + text + "</h3>\n              <button type=\"button\" class=\"close-modal text-gray-400 hover:text-gray-600\">\n                  <i class=\"fas fa-times\"></i>\n              </button>\n          </div>\n          \n          <form id=\"project-form\">\n              " + (isEdit ? "<input type=\"hidden\" name=\"id\" value=\"" + project[COL.P_ID] + "\">" : "") + "\n              \n              <div class=\"form-group\">\n                  <label class=\"form-label required\">Tên dự án</label>\n                  <input type=\"text\" name=\"name\" class=\"form-input\" required value=\"" + (isEdit ? project[COL.P_NAME] || "" : "") + "\" " + (isEdit && !isAdmin() && !isManager() ? "disabled" : "") + ">\n\n              </div>\n              \n              <div class=\"form-group\">\n                  <label class=\"form-label\">Mô tả</label>\n                  <textarea name=\"description\" class=\"form-textarea\" " + (isEdit && !isAdmin() && !isManager() ? "disabled" : "") + ">" + (isEdit ? project[COL.P_DESC] || "" : "") + "</textarea>\n              </div>\n              \n              <div class=\"form-group\">\n                  <label class=\"form-label\">Quản lý dự án</label>\n                  <select name=\"manager\" class=\"form-select\" " + (isEdit && !isAdmin() && !isManager() ? "disabled" : "") + " " + (isManager() && !isAdmin() ? "disabled" : "") + ">\n                      <option value=\"\">-- Chọn quản lý --</option>\n                      " + list.map(list2 => {
    let text3 = "";
...
function buildDepartmentOptions(selected) {
  const value = String(selected || "").trim(),
    ...
    options = list.map(name => "<option value=\"" + escapeHtmlAttr(name) + "\" " + (name === value ? "selected" : "") + ">" + name + "</option>");
...
function buildDeptRoleOptions(selected) {
  ...
  return ["Nhân viên", "Phó phòng", "Trưởng phòng"].map(name => "<option value=\"" + name + "\" " + (name === value ? "selected" : "") + ">" + name + "</option>").join("");
}
/** Escape để nhét an toàn vào thuộc tính HTML dựng bằng chuỗi. */
...
function createDepartmentTableRow(department) {
  ...
  return "\n        <tr class=\"hover:bg-gray-50 transition-colors\">\n            <td class=\"px-3 py-2 text-gray-500 whitespace-nowrap\">" + escapeHtmlAttr(departmentId) + (order === "" ? "" : " <span class=\"text-xs text-gray-400\">#" + escapeHtmlAttr(order) + "</span>") + "</td>\n            <td class=\"px-3 py-2 font-medium text-gray-900\">" + escapeHtmlAttr(departmentName) + " <span class=\"text-xs font-normal text-gray-500\">(" + staffCount + " người)</span></td>\n            <td class=\"px-3 py-2 text-gray-600\">" + describeEmailList(department[COL.D_DIRECTOR]) + "</td>\n            <td class=\"px-3 py-2 text-gray-600\">" + describeEmailList(department[COL.D_HEAD]) + "</td>\n            <td class=\"px-3 py-2 text-gray-600\">" + describeEmailList(department[COL.D_VICE]) + "</td>\n            <td class=\"px-3 py-2 text-center\">\n                <div class=\"flex justify-center gap-1\">\n                    <button type=\"button\" class=\"action-btn action-btn-edit\" title=\"Chỉnh sửa\" onclick=\"openDepartmentModal('" + escapeHtmlAttr(departmentId) + "')\">\n                        <i class=\"fas fa-edit text-xs\"></i>\n                    </button>\n                    <button type=\"button\" class=\"action-btn action-btn-delete\" title=\"Xóa\" onclick=\"confirmDeleteDepartment('" + escapeHtmlAttr(departmentId) + "')\">\n                        <i class=\"fas fa-trash text-xs\"></i>\n                    </button>\n                </div>\n            </td>\n        </tr>";
}
/**
...
function buildStaffEmailDatalist(listId, roleFilter) {
  ...
  return "<datalist id=\"" + listId + "\">" + source.map(staff => "<option value=\"" + escapeHtmlAttr(String(staff[COL.S_EMAIL]).trim().toLowerCase()) + "\">" + escapeHtmlAttr((staff[COL.S_NAME] || "") + (staff[COL.S_DEPT] ? " — " + staff[COL.S_DEPT] : "")) + "</option>").join("") + "</datalist>";
}
...
function renderGanttChart() {
  ...
  for (let i = 0; i < text; i++) {
    ...
    text2 += "\n        <div class=\"gantt-day " + (flag ? "weekend" : "") + " " + (isSameDate2 ? "today" : "") + " " + (flag2 ? "first-of-month" : "") + "\">\n          <div class=\"gantt-day-number\">" + date2 + "</div>\n          <div class=\"gantt-day-label\">" + (flag2 ? monthText : weekdayText) + "</div>\n        </div>\n      ", date.setDate(date.getDate() + 1);
  }
  el.innerHTML = text2;
  let text3 = "";
      ...
      text3 += "\n            <div class=\"gantt-project-group\" data-project-id=\"" + projectId + "\">\n              <div class=\"gantt-item\" data-id=\"" + projectId + "\" data-type=\"project\">\n                <div class=\"gantt-item-label\">\n                  <button class=\"gantt-toggle-btn mr-2\" data-project=\"" + projectId + "\">\n                    <i class=\"fas fa-chevron-right\"></i>\n                  </button>\n                  <i class=\"fas fa-folder " + getStatusIconClass(project[COL.P_STATUS]) + " mr-2\"></i>\n                  <span class=\"truncate\">" + project[COL.P_NAME] + "</span>\n                  <span class=\"gantt-task-count\">" + filteredTasks.length + "</span>\n                  \n                  <div class=\"gantt-item-actions\">\n                    <button class=\"action-btn action-btn-edit add-task-from-project-btn mr-1\" data-project-id=\"" + projectId + "\" data-project-name=\"" + project[COL.P_NAME] + "\" title=\"Thêm nhiệm vụ\">\n                      <i class=\"fas fa-plus\"></i>\n                    </button>\n                    <button class=\"action-btn action-btn-view view-project-btn mr-1\" data-type=\"project\" data-id=\"" + projectId + "\" data-name=\"" + project[COL.P_NAME] + "\" title=\"Xem chi tiết\">\n                      <i class=\"fas fa-eye\"></i>\n                    </button>\n                    " + (isAdmin() || project[COL.P_MANAGER] === currentUser.name && isManager() ? "\n                      <button class=\"action-btn action-btn-copy copy-btn mr-1\" data-type=\"project\" data-id=\"" + projectId + "\" data-name=\"" + project[COL.P_NAME] + "\" title=\"Tạo bản sao\">\n                        <i class=\"fas fa-copy\"></i>\n                      </button>\n                    " : "") + "\n                    " + (isAdmin() || project[COL.P_MANAGER] === currentUser.name ? "\n                      <button class=\"action-btn action-btn-edit edit-btn mr-1\" data-type=\"project\" data-id=\"" + projectId + "\" title=\"Chỉnh sửa\">\n                        <i class=\"fas fa-edit\"></i>\n                      </button>\n                    " : "") + "\n                    " + (isAdmin() || project[COL.P_MANAGER] === currentUser.name && isManager() ? "\n                      <button class=\"action-btn action-btn-delete delete-btn\" data-type=\"project\" data-id=\"" + projectId + "\" data-name=\"" + project[COL.P_NAME] + "\" title=\"Xóa\">\n                        <i class=\"fas fa-trash\"></i>\n                      </button>\n                    " : "") + "\n                  </div>\n                </div>\n                \n                <div class=\"gantt-item-timeline\">\n                  <div class=\"gantt-bar gantt-bar-project " + (flag ? "gantt-bar-overdue" : "") + "\" style=\"" + projectBarStyle + "\" data-tooltip=\"" + project[COL.P_NAME] + ": " + projectDesc + "\">\n                    <div class=\"gantt-bar-label\">" + projectStartText + " - " + projectEndText + ": " + projectDesc + "</div>\n                    <div class=\"gantt-progress\" style=\"width: " + num + "%\"></div>\n                  </div>\n                </div>\n              </div>\n              \n              <div class=\"gantt-project-tasks hidden\" id=\"gantt-tasks-" + projectId + "\">\n        " + filteredTasks.map(filteredTask => {
        ...
        if (true) {
          const taskBarStyle = calculateGanttBarStyleRange(taskStartDate, taskDueDate, ganttStartDate, ganttEndDate, text),
            ...
            isArray = Array.isArray(taskReminders) && taskReminders.length > 0,
            hasMatch = taskStatus.toLowerCase().includes("hoàn thành");
          return "\n                    <div class=\"gantt-item gantt-task-item draggable-item\" \n                        data-id=\"" + filteredTask[COL.T_ID] + "\" \n                        data-type=\"task\" \n                        data-project-id=\"" + filteredTask[COL.T_PID] + "\"\n                        draggable=\"true\">\n                      <div class=\"gantt-item-label task-clickable cursor-pointer\" data-id=\"" + filteredTask[COL.T_ID] + "\">\n                        <input type=\"checkbox\" \n                              class=\"quick-complete-checkbox ml-2\" \n                              data-id=\"" + filteredTask[COL.T_ID] + "\" \n                              data-name=\"" + filteredTask[COL.T_NAME] + "\"\n                              " + (hasMatch ? "checked disabled" : "") + " \n                              style=\"margin-right: 8px;\">\n                              \n                        <i class=\"fas fa-circle " + getStatusIcon(taskStatus) + " mr-2\" style=\"font-size: 8px;\"></i>\n                        <div class=\"flex flex-col min-w-0\">\n                          <span class=\"truncate flex items-center\">" + (isArray ? "<i class=\"fas fa-bell text-amber-500 flex-shrink-0\" style=\"margin-right: 1px; font-size: 10px;\" title=\"Có nhắc việc\"></i>" : "") + (taskPriority.toLowerCase().includes("cao") ? "<i class=\"fas fa-star text-yellow-400 flex-shrink-0\" style=\"margin-right: 2px; font-size: 10px;\"></i>" : "") + filteredTask[COL.T_NAME] + "</span>\n                          <span class=\"text-xs text-gray-500 truncate\">" + taskAssignee + " - " + taskStatus + " - " + taskPriority + "</span>\n                          " + (flag2 ? "<div class=\"mt-1\">" + renderLinksButton(taskResultLinks, filteredTask[COL.T_ID]) + "</div>" : "") + "\n                        </div>\n                        \n                        <div class=\"gantt-item-actions\">\n                          " + (() => {
            const project2 = project && project[COL.P_MANAGER] === currentUser.name,
              isAdmin2 = isAdmin() || project2;
            return "\n                              " + (isAdmin2 ? "<button class=\"action-btn action-btn-copy copy-btn mr-1\" data-type=\"task\" data-id=\"" + filteredTask[COL.T_ID] + "\" data-name=\"" + filteredTask[COL.T_NAME] + "\" title=\"Tạo bản sao\"><i class=\"fas fa-copy\"></i></button>" : "") + "\n                              <button class=\"action-btn action-btn-edit edit-btn mr-1\" data-type=\"task\" data-id=\"" + filteredTask[COL.T_ID] + "\" title=\"Chỉnh sửa\"><i class=\"fas fa-edit\"></i></button>\n                              " + (isAdmin2 ? "<button class=\"action-btn action-btn-delete delete-btn\" data-type=\"task\" data-id=\"" + filteredTask[COL.T_ID] + "\" data-name=\"" + filteredTask[COL.T_NAME] + "\" title=\"Xóa\"><i class=\"fas fa-trash\"></i></button>" : "") + "\n                              ";
          })() + "\n                        </div>\n                      </div>\n                      \n                      <div class=\"gantt-item-timeline\">\n                          " + (isDateInRange(taskStartDate, ganttStartDate, ganttEndDate) || isDateInRange(taskDueDate, ganttStartDate, ganttEndDate) || taskStartDate < ganttStartDate && taskDueDate > ganttEndDate ? "<div class=\"gantt-bar gantt-bar-task " + (isTaskOverdue2 ? "gantt-bar-overdue" : "") + "\" style=\"" + taskBarStyle + "\" data-tooltip=\"" + filteredTask[COL.T_NAME] + ": " + taskDesc + "\">\n                              <div class=\"gantt-bar-label\">" + taskStartText + " - " + taskDueText + ": " + taskDesc + "</div>\n                              <div class=\"gantt-progress\" style=\"width: " + num2 + "%\"></div>\n                          </div>" : "<div class=\"gantt-non-visible-task\" style=\"height: 20px; display: flex; align-items: center; justify-content: center; color: #666; font-size: 11px; font-style: italic;\">\n                              " + taskStartText + " - " + taskDueText + ": Không hiển thị trong khoảng này\n                          </div>") + "\n                      </div>\n                    </div>\n                  ";
        }
        return "";
      }).join("") + "\n      </div>\n    </div>\n  ";
    }
...
function openEditReminderModal(taskId, reminderIndex, date, content) {
  const text = "\n            <div id=\"reminder-modal\" class=\"modal active\" style=\"z-index: 200;\">\n                <div class=\"modal-content max-w-md\">\n                    <div class=\"flex items-center justify-between mb-6\">\n                        <h3 class=\"text-xl font-bold text-gray-900\">\n                            <i class=\"fas fa-edit text-blue-500 mr-2\"></i>\n                            Sửa nhắc việc\n                        </h3>\n                        <button type=\"button\" onclick=\"closeReminderModal()\" class=\"text-gray-400 hover:text-gray-600\">\n                            <i class=\"fas fa-times\"></i>\n                        </button>\n                    </div>\n                    \n                    <form id=\"reminder-form\">\n                        <input type=\"hidden\" name=\"taskId\" value=\"" + taskId + "\">\n                        <input type=\"hidden\" name=\"reminderIndex\" value=\"" + reminderIndex + "\">\n                        \n                        <div class=\"form-group\">\n                            <label class=\"form-label required\">Ngày nhắc</label>\n                            <input type=\"date\" name=\"date\" class=\"form-input\" required value=\"" + date + "\">\n                        </div>\n                        \n                        <div class=\"form-group\">\n                            <label class=\"form-label\">Nội dung</label>\n                            <textarea name=\"content\" class=\"form-textarea\" rows=\"3\" placeholder=\"Nhập nội dung nhắc việc...\">" + (content || "") + "</textarea>\n                        </div>\n                        \n                        <div class=\"flex justify-end space-x-3 mt-6\">\n                            <button type=\"button\" class=\"btn-secondary\" onclick=\"closeReminderModal()\">Hủy</button>\n                            <button type=\"submit\" class=\"btn-primary\">Cập nhật</button>\n                        </div>\n                    </form>\n                </div>\n            </div>\n        ",
    el = document.createElement("div");
  el.id = "reminder-modal-container", el.innerHTML = text, document.body.appendChild(el);
  const reminderFormEl = document.getElementById("reminder-form");
  reminderFormEl.addEventListener("submit", function (event) {
...
function formatTaskLinks(linksValue) {
  ...
  return filtered.map((filtered2, index) => {
    return "<a href=\"" + filtered2 + "\" target=\"_blank\" class=\"text-blue-600 hover:underline\">Link " + (index + 1) + "</a>";
  }).join(" | ");
}
...
function renderPriorityTasksMini() {
  ...
  priorityTasksMiniEl.innerHTML = filteredList.map(filteredList2 => {
    const taskName = filteredList2[COL.T_NAME] || "Chưa có tên",
      ...
      isArray = Array.isArray(taskReminders) && taskReminders.length > 0;
    return "\n  <div class=\"p-4 border border-orange-200 bg-gradient-to-br from-orange-50 to-red-50 rounded-lg hover:shadow-md transition-all duration-200 hover:border-orange-300 task-clickable cursor-pointer\" data-id=\"" + filteredList2[COL.T_ID] + "\">\n    <div class=\"flex items-start justify-between mb-3\">\n      <h5 class=\"font-semibold text-gray-900 text-sm leading-tight flex-1 mr-2\">" + (isArray ? "<i class=\"fas fa-bell text-amber-500 mr-1\" title=\"Có nhắc việc\"></i>" : "") + taskName + "</h5>\n      <div class=\"flex items-center space-x-2\">\n        " + (isTaskOverdue2 ? "<span class=\"status-badge status-overdue text-xs\">Quá hạn</span>" : "<span class=\"status-badge priority-high text-xs\">Cao</span>") + "\n        \n        <div class=\"flex space-x-1\">\n          " + (() => {
      ...
      return "\n              " + (isAdmin2 ? "<button class=\"action-btn action-btn-copy copy-btn\" data-type=\"task\" data-id=\"" + filteredList2[COL.T_ID] + "\" data-name=\"" + taskName + "\" title=\"Tạo bản sao\"><i class=\"fas fa-copy\"></i></button>" : "") + "\n              <button class=\"action-btn action-btn-edit edit-btn\" data-type=\"task\" data-id=\"" + filteredList2[COL.T_ID] + "\" title=\"Chỉnh sửa\"><i class=\"fas fa-edit\"></i></button>\n              " + (isAdmin2 ? "<button class=\"action-btn action-btn-delete delete-btn\" data-type=\"task\" data-id=\"" + filteredList2[COL.T_ID] + "\" data-name=\"" + taskName + "\" title=\"Xóa\"><i class=\"fas fa-trash\"></i></button>" : "") + "\n            ";
    })() + "\n        </div>\n      </div>\n    </div>\n    \n    <div class=\"text-xs text-gray-600 space-y-1 mb-3\">\n      <div class=\"flex items-center justify-between\">\n        <div class=\"flex items-center flex-1\">\n          <i class=\"fas fa-folder text-purple-500 mr-1 w-3\"></i>\n          <span class=\"truncate\">" + text + "</span>\n        </div>\n      </div>\n\n      <div class=\"flex items-center justify-between\">\n        <div class=\"flex items-center flex-1\">\n          <i class=\"fas fa-user text-blue-500 mr-1 w-3\"></i>\n          <span class=\"truncate\">" + taskAssignee + "</span>\n        </div>\n        <div class=\"flex items-center ml-2\">\n          <i class=\"fas fa-calendar " + (isTaskOverdue2 ? "text-red-500" : "text-green-500") + " mr-1 w-3\"></i>\n          <span>" + dueDateText + "</span>\n        </div>\n      </div>\n    </div>\n    \n    <div class=\"flex items-center\">\n      <span class=\"text-xs font-semibold text-gray-700 min-w-[35px]\">" + num + "%</span>\n      <div class=\"flex-1 h-2 bg-gray-200 rounded-full ml-2\">\n        <div class=\"h-full " + (num === 0 ? "bg-gray-400" : "bg-gradient-to-r from-orange-400 to-red-500") + " rounded-full transition-all duration-500\" style=\"width: " + Math.max(num, 5) + "%\"></div>\n      </div>\n    </div>\n  </div>\n";
  }).join("");
}
...
function showStaffValidationError(validation) {
  ...
  validation.length > 0 ? (staffValidationErrorEl.innerHTML = validation.map(validation2 => "<div class=\"text-red-600 text-sm\">" + validation2 + "</div>").join(""), staffValidationErrorEl.classList.remove("hidden")) : staffValidationErrorEl.classList.add("hidden");
}
function renderTaskStats() {
  ...
  document.getElementById("tasks-pending-count").innerHTML = "<i class=\"fas fa-pause-circle text-sm\"></i>" + data.pending, document.getElementById("tasks-active-count").innerHTML = "<i class=\"fas fa-play-circle text-sm\"></i>" + data.active, document.getElementById("tasks-completed-count").innerHTML = "<i class=\"fas fa-check-circle text-sm\"></i>" + data.completed, document.getElementById("tasks-paused-count").innerHTML = "<i class=\"fas fa-pause text-sm\"></i>" + data.paused;
}
function renderProjectStats() {
  ...
  document.getElementById("projects-pending-count").innerHTML = "<i class=\"fas fa-pause-circle text-sm\"></i>" + data.pending, document.getElementById("projects-active-count").innerHTML = "<i class=\"fas fa-play-circle text-sm\"></i>" + data.active, document.getElementById("projects-completed-count").innerHTML = "<i class=\"fas fa-check-circle text-sm\"></i>" + data.completed, document.getElementById("projects-paused-count").innerHTML = "<i class=\"fas fa-pause text-sm\"></i>" + data.paused, document.getElementById("projects-canceled-count").innerHTML = "<i class=\"fas fa-times-circle text-sm\"></i>" + data.canceled;
}
  ...
  statListContainerEl.innerHTML = items.map(item => {
    if (type === "project") {
      const projectId = item[COL.P_ID],
        ...
        filteredTaskTotal = filteredTasks.reduce((acc, filteredTask) => acc + parseInt(filteredTask[COL.T_COMPLETION] || 0), 0),
        num = filteredTasks.length > 0 ? Math.round(filteredTaskTotal / filteredTasks.length) : 0;
      return "\n            <div class=\"stat-list-item rounded-xl border border-gray-100 hover:border-blue-200 bg-white p-3 mb-2 shadow-sm transition-all\" \n                  onclick=\"showProjectDetailsModal('" + projectId + "', '" + projectName + "')\">\n                \n                <div class=\"flex justify-between items-start mb-2\">\n                    <div>\n                        <div class=\"font-bold text-gray-800 text-sm\">" + projectName + " <span class=\"text-gray-400 font-normal text-xs ml-1\">(" + projectId + ")</span></div>\n                        <div class=\"text-xs text-gray-500 mt-1 flex items-center gap-3\">\n                            <span><i class=\"fas fa-user-tie mr-1 text-purple-500\"></i>" + projectManager + "</span>\n                            <span><i class=\"fas fa-calendar-alt mr-1 text-blue-500\"></i>" + startDateText + " - " + endDateText + "</span>\n                        </div>\n                    </div>\n                    <span class=\"status-badge " + getStatusClass(projectStatus) + "\">" + projectStatus + "</span>\n                </div>\n\n                <div class=\"flex items-center gap-2\">\n                    <div class=\"flex-1 h-1.5 bg-gray-100 rounded-full overflow-hidden\">\n                        <div class=\"h-full bg-blue-500 rounded-full\" style=\"width: " + num + "%\"></div>\n                    </div>\n                    <span class=\"text-xs font-medium text-gray-600 min-w-[30px] text-right\">" + num + "%</span>\n                </div>\n            </div>\n        ";
    } else {
      ...
      return "\n            <div class=\"stat-list-item rounded-xl border border-gray-100 hover:border-blue-200 bg-white p-3 mb-2 shadow-sm transition-all " + (isTaskOverdue2 ? "border-l-4 border-l-red-500" : "") + "\" \n                  onclick=\"if(canUserEditResource('task', '" + taskId + "')) openEditModal('task', '" + taskId + "')\">\n                \n                <div class=\"flex justify-between items-start mb-1\">\n                    <div class=\"flex-1 pr-2\">\n                        <div class=\"font-semibold text-gray-800 text-sm leading-snug\">" + taskName + "</div>\n                    </div>\n                    \n                    <div class=\"flex items-center gap-2 shrink-0\">\n                        <span class=\"status-badge " + getStatusClass(taskStatus) + "\">" + taskStatus + "</span>\n                        " + (isTaskOverdue2 ? "<span class=\"status-badge status-overdue\">Quá hạn</span>" : "") + "\n                    </div>\n                </div>\n\n                <div class=\"grid grid-cols-2 gap-y-1 text-xs text-gray-500 mt-1 mb-2\">\n                    <div class=\"col-span-2 flex items-center text-gray-600 font-medium\">\n                        <i class=\"fas fa-folder-open mr-1.5 text-yellow-500\"></i>" + projectName + "\n                    </div>\n                    <div class=\"flex items-center\">\n                        <i class=\"fas fa-user mr-1.5 text-blue-400\"></i>" + taskAssignee + "\n                    </div>\n                    <div class=\"flex items-center justify-end\">\n                        <i class=\"fas fa-clock mr-1.5 " + (isTaskOverdue2 ? "text-red-500" : "text-green-500") + "\"></i>" + dueDateText + "\n                    </div>\n                </div>\n\n                <div class=\"flex items-center gap-2\">\n                    <div class=\"flex-1 h-1.5 bg-gray-100 rounded-full overflow-hidden\">\n                        <div class=\"h-full " + (num === 100 ? "bg-green-500" : "bg-blue-500") + " rounded-full\" style=\"width: " + num + "%\"></div>\n                    </div>\n                    <span class=\"text-xs font-medium text-gray-600 min-w-[30px] text-right\">" + num + "%</span>\n                </div>\n            </div>\n        ";
    }
  }).join("");
}
...
function createProposalRow(proposal) {
  ...
  return "\n        <div class=\"proposal-row clickable\" data-id=\"" + proposalId + "\" style=\"grid-template-columns: 120px 1fr 1fr 120px 100px 80px;\">\n            <div class=\"flex flex-col items-center gap-1 sticky left-0 z-10 bg-white border-r border-gray-100 shadow-sm p-2 justify-center\">\n                <span class=\"text-[10px] px-1 py-0.5 rounded-full whitespace-nowrap " + text + "\">" + proposalType + "</span>\n                <span class=\"text-xs font-mono text-gray-500\">" + proposalId + "</span>\n            </div>\n            <div>\n                " + (flag && projectName ? "<p class=\"text-xs text-gray-500\"><i class=\"fas fa-folder mr-1\"></i>" + projectName + " " + (taskName ? "→ " + taskName : "") + "</p>" : "<p class=\"text-xs text-gray-400\">Ngoài kế hoạch</p>") + "\n                <div class=\"mt-1\">\n                    " + renderLinksButton(proposalUrl, proposalId) + "\n                </div>\n                " + (proposalNote ? "<p class=\"text-xs text-orange-600 mt-1\"><i class=\"fas fa-comment-alt mr-1\"></i>Ghi chú: " + proposalNote + "</p>" : "") + "\n            </div>\n            <div>\n                <p class=\"text-sm text-gray-900 line-clamp-3\">" + proposalContent + "</p>\n            </div>\n            <div class=\"text-sm text-gray-600\">\n                <i class=\"fas fa-user mr-1\"></i>" + proposalCreator + "\n            </div>\n            <div class=\"text-sm text-gray-500\">\n                <i class=\"fas fa-calendar mr-1\"></i>" + dateText + "\n            </div>\n            <div class=\"flex gap-2 justify-center\">\n                " + (canUserEditResource("proposal", proposalId) ? "\n                <button class=\"action-btn action-btn-edit edit-btn\" data-type=\"proposal\" data-id=\"" + proposalId + "\" title=\"Chỉnh sửa\" onclick=\"event.stopPropagation(); openEditModal('proposal', '" + proposalId + "')\">\n                    <i class=\"fas fa-edit\"></i>\n                </button>" : "") + "\n                " + (canUserDeleteResource("proposal", proposalId) ? "\n                <button class=\"action-btn action-btn-delete delete-btn\" data-type=\"proposal\" data-id=\"" + proposalId + "\" data-name=\"" + proposalId + "\" title=\"Xóa\" onclick=\"event.stopPropagation(); confirmDelete('proposal', '" + proposalId + "', '" + proposalId + "')\">\n                    <i class=\"fas fa-trash\"></i>\n                </button>" : "") + "\n            </div>\n        </div>";
}
...
function updateProposalTasks() {
  ...
  proposalTaskEl.innerHTML = "<option value=\"\">-- Chọn nhiệm vụ --</option>" + filteredTasks.map(filteredTask => "<option value=\"" + filteredTask[COL.T_ID] + "\">" + filteredTask[COL.T_NAME] + " (" + filteredTask[COL.T_ID] + ")</option>").join(""), taskDetailsContainerEl && (taskDetailsContainerEl.innerHTML = "");
}
function showTaskDetails() {
  ...
  taskDetailsContainerEl.innerHTML = "\n            <div class=\"bg-gray-50 p-3 rounded-lg text-sm space-y-1 mt-2\">\n                <p><strong>Nhiệm vụ:</strong> " + task[COL.T_NAME] + "</p>\n                <p><strong>Người thực hiện:</strong> " + (task[COL.T_ASSIGNEE] || "Chưa gán") + "</p>\n                <p><strong>Trạng thái:</strong> " + (task[COL.T_STATUS] || "Chưa bắt đầu") + "</p>\n                <p><strong>Tiến độ:</strong> " + (task[COL.T_COMPLETION] || 0) + "%</p>\n                " + (task[COL.T_DUE] ? "<p><strong>Hạn chót:</strong> " + formatDateForDisplay(task[COL.T_DUE]) + "</p>" : "") + "\n            </div>\n        ";
}
document.addEventListener("DOMContentLoaded", function () {
  ...
  sorted.forEach((sorted2, index) => {
    ...
    text += "\n                <div class=\"col-span-full " + (index > 0 ? "mt-6" : "mt-0") + "\">\n                    <div class=\"flex items-center gap-3 mb-2\">\n                        <div class=\"w-1 h-6 bg-gradient-to-b from-blue-500 to-purple-600 rounded-full\"></div>\n                        <h3 class=\"text-lg font-bold text-gray-800\">" + sorted2 + "</h3>\n                        <span class=\"text-xs text-gray-500 bg-gray-100 px-2 py-0.5 rounded-full\">" + data2.length + " ứng dụng</span>\n                    </div>\n                </div>\n            ", data2.forEach(data22 => {
      const appIcon = data22[COL.A_ICON] || "https://cdn-icons-png.flaticon.com/512/3212/3212608.png",
        ...
        text2 = isAdmin2 ? "\n                    <div class=\"admin-controls absolute top-2 right-2 invisible group-hover:visible flex gap-1 bg-white/80 backdrop-blur-sm rounded-lg p-1 shadow-sm transition-all z-10\">\n                        <button class=\"edit-btn p-1.5 text-blue-600 hover:bg-blue-50 rounded-md transition-colors\" data-type=\"app\" data-id=\"" + appId + "\" title=\"Sửa\">\n                            <i class=\"fas fa-edit text-xs\"></i>\n                        </button>\n                        <button class=\"delete-btn p-1.5 text-red-600 hover:bg-red-50 rounded-md transition-colors\" data-type=\"app\" data-id=\"" + appId + "\" title=\"Xóa\">\n                            <i class=\"fas fa-trash text-xs\"></i>\n                        </button>\n                    </div>\n                " : "",
        text3 = isAdmin2 && flag ? "bg-gradient-to-r from-blue-100/80 via-purple-100/60" : "";
      text += "\n                    <div class=\"glass-card hover:shadow-lg transition-all duration-300 cursor-pointer group relative p-3 flex items-center gap-3 border border-gray-100/50 hover:border-blue-200 " + text3 + "\" onclick=\"handleAppRedirect('" + appUrl + "', event)\" " + (flag && isAdmin2 ? "title=\"Đã phân quyền: " + appPermissions + "\"" : "") + ">\n                        " + text2 + "\n                        <div class=\"w-10 h-10 rounded-xl shadow overflow-hidden transform group-hover:scale-105 transition-transform duration-300 bg-white p-0.5 flex-shrink-0\">\n                            <img src=\"" + appIcon + "\" class=\"w-full h-full object-contain rounded-lg\" onerror=\"this.src='https://cdn-icons-png.flaticon.com/512/3212/3212608.png'\" alt=\"" + appName + "\">\n                        </div>\n                        <div class=\"flex-1 min-w-0\">\n                            <h4 class=\"font-semibold text-gray-800 text-sm group-hover:text-blue-600 transition-colors truncate\" title=\"" + appName + "\">" + appName + "</h4>\n                            <p class=\"text-xs text-gray-500 truncate\">" + appDesc + "</p>\n                        </div>\n                    </div>\n                ";
    });
