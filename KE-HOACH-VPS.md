...
| 6 | Thống kê, lọc, Gantt | ⬜ | **Việc kế tiếp.** §7 việc 6.1–6.9; §8.4 nhóm F (TC-STAT-01..16). Chú ý 6.4 lọc tháng theo **giao nhau** khoảng ngày; 6.9 đối chiếu Apps Script **chênh 0**; nợ Phase 4: `getTasks` N+1 — gộp một truy vấn. T1–T10/R1–R7 đã có nguồn bootstrap, Phase 6 làm phần vẽ/lọc/Gantt. **Không** làm nút Duyệt (D3–D8 UI) trừ khi người dùng yêu cầu. |
