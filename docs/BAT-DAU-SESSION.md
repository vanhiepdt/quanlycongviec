...
> ⚠ **LỖI THỜI (2026-09-06)**: prompt dưới đây viết khi CHƯA có VPS thật (1263 test, nhánh
> cũ). Nay đã có VPS + chứng chỉ TLS + nhánh mới — **dùng `docs/PROMPT-PHASE-8.md` mục 2**
> thay thế. Khối dưới giữ lại chỉ để tham khảo khuôn.
